...
@section('content')
    ...
    <div class="@if($themeapply[0]->video == 1){{ 'section-video' }} @endif">
                    <video autoplay="" class="bgvid" loop="" muted="">
                        ...
                        <source src="@if($themeapply[0]->video == 1){{  url('') }}/{{ $assetvideo[0]->storage }} @endif" type="video/mp4">
                        <!-- <source src="video/video.ogv" type="video/ogv"> -->
                    </video>
                </div>
        <div class="home-ovimg">
            <div class="container">
                <div class="row xs-column-reverse section-separator vertical-middle-content home-padding"  <?php if($themeapply[0]->image ==1){ echo "style=' padding-top:0px;'";}  ?> <?php if($themeapply[0]->static ==1){ echo "style=' padding-top:0px;'";}  ?>>
                    <div class="col-sm-6">
        ...
        <div class="container">
         <div class="row">
            ...
            <div id="accordion" class="myaccordion">
             ...
             <div class="card">
                 <div class="card-header headerwhitetheme" id="D{{ $skc->category }}">
                 <h2 class="mb-0">
                 <button class="d-flex align-items-center justify-content-between btn btn-link collapsed wthemeAccHead" data-toggle="collapse" data-target="#{{ $skc->category }}" aria-expanded="false" aria-controls="{{ $skc->category }}">
                 {{ $skc->category }}
                 ...
                 <div id="{{ $skc->category }}" class="collapse <?php if($count == 1){ echo 'show';  } ?>" aria-labelledby="D{{ $skc->category }}">
                     <div class="card-body bodywhitetheme">
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                        ...
                        <div class="blog-inner">
                            <h2><a href="blog-single.html">{{ $bg->title }}</a></h2>
