    ...
    <div class="row align-items-end">
        <div class="col-lg-8">
            <div class="page-header-title">
                <div class="d-inline">
                    <h4>Categories</h4>
                    <span>Add Categories to filter your blog post in Categories order</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class="breadcrumb-title">
                    ...
                    <li class="breadcrumb-item"><a href="{{ url('admin/blog/category') }}">Categories</a>
                    </li>
                </ul>
            </div>
        </div>
                                ...
                                <div class="card col-sm-6">
                                    <div class="accordion-panel">
                                        ...
                                        <div class="accordion-content accordion-desc">
                                            <form action="{{ url('admin/blog/category/edit') }}/{{ $thecategory->id }}" method="post">
                                            <div class="form-group row">
                                                <label class="col-sm-12 col-form-label">Categories Name <i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="top" title="The name is how it appears on your site."></i> </label>
                                                {{ csrf_field() }}
                                                <div class="col-sm-12">
                                                    <input type="text"  class="form-control"  name="category" value="{{ $thecategory->category }}" placeholder="Add Categories Name"   required>
                                                     <input type="hidden"  name="slug" value="{{ $thecategory->slug }}"  >
                                                </div>
                                            </div>
                                            
                                            <div class="">
                                                <button class="btn btn-mat btn-info ">Update</button>
                                                <a href="{{ url('admin/blog/category/remove') }}/{{ $thecategory->id }}" class="btn btn-mat btn-danger ">Remove</a>
                                            </div>
                                            </form>
                                        </div>
                                        </div>
