                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12">
                        <div class="mh-blog-item dark-bg blog-single">
                            <img src="{{ url('') }}/{{ $blog[0]->featuredimage }}" style="width: 100% !important" alt="" class="img-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 mh-copyright wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <ul class="social-icon">
                                                <li><a href="{{ $personal[0]->linkedin }}"><i class="fa fa-linkedin"></i></a></li>
                                                <li><a href="{{ $personal[0]->twitter }}"><i class="fa fa-twitter"></i></a></li>
                                                <li><a href="{{ $personal[0]->github }}"><i class="fa fa-github"></i></a></li>
                                                <li><a href="{{ $personal[0]->medium }}"><i class="fa fa-medium"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
