...
<head>
    ...
    <!-- FAV AND ICONS   -->
    <link rel="shortcut icon" href="{{ url('') }}/theme1/assets/images/iconpp.ico">
    <link rel="shortcut icon" href="{{ url('') }}/theme1/assets/images/apple-icon.png">
    <link rel="shortcut icon" sizes="72x72" href="{{ url('') }}/theme1/assets/images/apple-icon-72x72.png">
    <link rel="shortcut icon" sizes="114x114" href="{{ url('') }}/theme1/assets/images/apple-icon-114x114.png">

    <!-- Google Font-->
    <link href="//fonts.googleapis.com/css?family=Roboto" rel="stylesheet">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/icons/font-awesome-4.7.0/css/font-awesome.min.css">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/plugins/css/bootstrap.min.css">
    <!-- Animate CSS-->
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/plugins/css/animate.css">
    <!-- Owl Carousel CSS-->
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/plugins/css/owl.css">
    <!-- Fancybox-->
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/plugins/css/jquery.fancybox.min.css">
    <!-- Custom CSS-->
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/css/styles.css">
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/css/responsive.css">
    
    <!-- timeline -->
    <link rel="stylesheet" type="text/css" href="{{ url('') }}/theme1/assets/css/timeline.css">
    <link rel="stylesheet" type="text/css" href="{{ url('') }}/theme1/css/education.css">


    <!-- Testing with athemeart template -->
        <link rel="stylesheet" type="text/css" href="{{ url('') }}/theme1/css/style.css">
    ...
    <!-- Colors -->
    <link rel="alternate stylesheet" href="{{ url('') }}/theme1/assets/css/colors/blue.css" title="blue">
    <link rel="stylesheet" href="{{ url('') }}/theme1/assets/css/colors/defauld.css" title="defauld">
    <link rel="alternate stylesheet" href="{{ url('') }}/theme1/assets/css/colors/green.css" title="green">
    <link rel="alternate stylesheet" href="{{ url('') }}/theme1/assets/css/colors/blue-munsell.css" title="blue-munsell">
    <link rel="alternate stylesheet" href="{{ url('') }}/theme1/assets/css/colors/orange.css" title="orange">
    <link rel="alternate stylesheet" href="{{ url('') }}/theme1/assets/css/colors/purple.css" title="purple">
    <link rel="alternate stylesheet" href="{{ url('') }}/theme1/assets/css/colors/slate.css" title="slate">
    <link rel="alternate stylesheet" href="{{ url('') }}/theme1/assets/css/colors/yellow.css" title="yellow">
